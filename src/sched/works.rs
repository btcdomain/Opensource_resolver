...
// lazy_static! {
//     pub static ref SYNC_DATA_THREAD: Arc<RwLock<VecDeque<String>>> = Arc::new(RwLock::new(VecDeque::new()));
//     pub static ref CUR_NUMBER_THREAD: Arc<RwLock<VecDeque<u64>>> = Arc::new(RwLock::new(VecDeque::new()));
// }



// pub async fn sched_work() {
//     info_!("sched_work start");
